...
export const getAllPizzas = () => async (dispatch) => {
  ...
  try {
    const response = await axios.get(`${API_URL}/api/pizzas/getAllPizzas`);
...
export const addPizza = (pizza) => async (dispatch) => {
  ...
  try {
    await axios.post(`${API_URL}/api/pizzas/addpizza`, { pizza });
...
export const getPizzaById = (pizzaId) => async (dispatch) => {
  ...
  try {
    const response = await axios.post(`${API_URL}/api/pizzas/getpizzabyid`, { pizzaId });
...
export const updatePizza = (updatedPizza) => async (dispatch) => {
  ...
  try {
    const response = await axios.post(`${API_URL}/api/pizzas/updatepizza`, {
      updatedPizza,
    });
...
export const deletePizza = (pizzaId) => async (dispatch) => {
  try {
    await axios.post(`${API_URL}/api/pizzas/deletepizza`, { pizzaId });
